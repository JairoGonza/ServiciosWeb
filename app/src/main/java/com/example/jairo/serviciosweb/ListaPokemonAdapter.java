...
public class ListaPokemonAdapter extends RecyclerView.Adapter<ListaPokemonAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.habilidadTextView.setText("Para conocer las habilidades y mas informacion de "+p.getName()+" presiona su imagen");
        ...
        holder.fotoImageView.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra( "idpoke",p.getNumber());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView habilidadTextView;
        ...
        public ViewHolder(View itemView) {
            ...
            habilidadTextView = (TextView) itemView.findViewById(R.id.habilidadTextView);
        }
    }
}